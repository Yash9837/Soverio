...
const Header = () => {
  return (
    ...
    <nav class="  text-xl bg-gradient-to-b   px-4 lg:px-12 py-6 font-mono ">
        <div class="flex  items-center justify-between mx-auto ">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="#" class="block py-3 pr-4 pl-4 text-black border-b border-gray-100 rounded-xl hover:bg-gray-50 bg-white lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-black lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700 lg:px-1">Contact</a>
                    </li>
                    {/* <li>
